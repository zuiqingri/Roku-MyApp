    ...
    if press = false then
        ...
        if key = "OK" then
            ...
            if m.Search.visible = true and m.Search.focusedChild <> invalid and m.Search.focusedChild.id = "SearchDetailsScreen"
                ...
                m.gridScreen.focusedContent.HDBACKGROUNDIMAGEURL = m.Search.focusedContent.HDBACKGROUNDIMAGEURL
                m.gridScreen.focusedContent.id = m.Search.focusedContent.id
                m.gridScreen.focusedContent.HDPOSTERURL = m.Search.focusedContent.HDPOSTERURL
                m.gridScreen.focusedContent.TITLE = m.Search.focusedContent.TITLE
                m.gridScreen.focusedContent.contentId = m.Search.focusedContent.contentId
                m.gridScreen.focusedContent.DESCRIPTION = m.Search.focusedContent.DESCRIPTION
                m.gridScreen.focusedContent.LENGTH = m.Search.focusedContent.LENGTH
                m.gridScreen.focusedContent.STREAMFORMAT = m.Search.focusedContent.STREAMFORMAT
                m.gridScreen.focusedContent.URL = m.Search.focusedContent.URL

                m.gridScreen.content = m.Search.content
                m.gridScreen.rowItemSelected = m.Search.rowItemSelected
                m.gridScreen.rowList = m.Search.gridScreen
